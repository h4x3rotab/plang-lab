...
public:
  ...
  inline char* content() const { return sp; }
...
public:
  ...
  // The above declaration was removed because it can't use a 'friend' attribute
  // in a templated class's operation overriding. Insteadly, just implement the
  // overrided operation outside the class is all right.
